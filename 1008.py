...
numerof = int(input("Digite o numero do funcionário: "))
horast = int(input("Digite quantas horas de trabalho: "))
valorh = float(input("Digite o valor das horas trabalhadas: "))


salario =  (valorh * horast)

print(f"Funcionário: {numerof}, seu salário seria: ${salario:.2f} ")
