...
n = 3.14159
raio = float(input("digite o valor do raio que deseja:")) #usamos tipo de dados float para que o usuário possa colocar tipo 5.2, 10,9, não pode ser int

area = n*(raio**2) #dois ** seria elevado a dois são de potência!!

print("O valor da area seria:", area)